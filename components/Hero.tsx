    ...
    <section className="relative w-full h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-6 text-center mt-24 md:mt-20">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-extrabold text-white leading-tight tracking-tight mb-6 drop-shadow-xl">
            Doğadan Gelen <br />
            <span className="text-emerald-400">Gerçek Sağlık</span>
          </h1>
          
          <p className="text-base sm:text-lg md:text-2xl text-white/90 mb-10 font-medium max-w-2xl mx-auto drop-shadow-md">
